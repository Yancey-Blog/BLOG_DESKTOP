    ...
    return (
      <section>
        <div className={styles.legal_header_container}>
          <h1 className={styles.legal_header}>Privacy Policy</h1>
          <p className={styles.legal_intro}>
            Respect for your privacy is coded into our DNA. Since we started,
            we’ve aspired to build our Services with a set of strong privacy
            principles in mind.
          </p>
        </div>
        ...
        <ul className={styles.legal_list}>
          ...
          <li className={styles.legal_item}>
            ...
            <ul>
              <li>
                <p>
                  <span>Withdraw their consent at any time. </span>Users have
              ...
              <li>
                <p>
                  <span>Object to processing of their Data. </span>Users have
              ...
              <li>
                <p>
                  <span>Access their Data. </span>Users have the right to learn
              ...
              <li>
                <p>
                  <span>Verify and seek rectification. </span>Users have the
              ...
              <li>
                <p>
                  <span>Restrict the processing of their Data. </span>Users have
              ...
              <li>
                <p>
                  ...
                  Data is processed by automated means and that the processing
                  is based on the User’s consent, on a contract which the User
                  is part of or on pre-contractual obligations thereof.
                </p>
              </li>
              <li>
                <p>
                  <span>Lodge a complaint. </span>Users have the right to bring
          ...
          <li className={styles.legal_item}>
            ...
            <p>
              ...
              its own advertising network. Personal Data collected: Cookies and
              Usage Data.
            </p>
            <p>
            ...
            <p>
              Place of processing: United States –{' '}
              <a
                href='https://help.github.com/articles/github-terms-of-service/#b-api-terms'
                target='_blank'
                rel='noopener noreferrer'
              >
                Privacy Policy
